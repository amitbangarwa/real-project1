...
$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
$db=mysql_select_db("art_gallery",$cn);
$sql="select * from gallery where artistname='$aid'";
$rs=mysql_query($sql,$cn);
$rsitem=mysql_fetch_object($rs);


echo "<table width='100%' border='0' cellpadding='0' cellspacing='0'>";
echo"<h4>Artist Products ($aid)</h4>";
...
echo "<br><a href='view.php?pid=$rsitem->picid'><img style='border: 1px solid rgb(4, 3, 1); margin: 5px; width: 156px;' src='art/$rsitem->img_name' title='Click to see description' ></a><br>       ";                             
echo"<br><a href='view.php?pid=$rsitem->picid'><b><u><font size=2>$rsitem->picname</font></u></b></a><br><br><a href='art/$rsitem->img_name' rel='lytebox[vacation]' title='$rsitem->picname'>Click to enlarge </a><br>                    <br>                       ";
echo "</td>";

}
echo"</tr>";
echo"</table>";
echo"<h4 align='left'>There are ".$count." paints of $aid<h4>";
