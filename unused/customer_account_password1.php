...
function check()
{
var t1=document.account_password.password_new.value;
var t2=document.account_password.password_confirmation.value;
if(t1=="" || t2=="")
...
else
{
	...
	if($pass1 == $pass2)
	{
	$query="UPDATE customerinfo SET password='$pass2' WHERE email_address='$usrname'";
	if($query)
	echo "<br><center><b><font color='red' size=4>PASSWORD CHANGED SUCCESSFULLY.</font></b></center>";
	}
	else
	{
	echo "<br><center><b><font color='red' size=4>Error! Your Password Did Not Match.</font></b></center>";
	}
