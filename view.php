...
echo"</td>";
echo"<td class='pageHeading' align='right' valign='top'>";

echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ $rsitem->price <br>";
echo"<a href='add_cart.php?pid=$rsitem->picid'><img src='image/button_in_cart.gif' alt='Add to Cart' title=' Add to Cart '></a>";
echo"</td>";
echo"</tr>";
