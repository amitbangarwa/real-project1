...
<li><nobr><a href='../logoff.php' class='headerNavigation'>Log Off</a></nobr>
</li>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> » <a href="architecture.php" class="headerNavigation">Architecture Painting</a></td>
        <td align="right">
...
$db=mysql_select_db("art_gallery",$cn);
$count=0;
$sql="select * from gallery where cat='Architecture'";
$rs=mysql_query($sql,$cn);
...
$count=$count+1;
echo "<td>";
echo "<a href='view.php?pid=$rsitem->picid'><img style='border: 1px solid rgb(4, 3, 1); margin: 5px; width: 156px;' src='art/$rsitem->img_name' title='Click to see description' width='100' border='0' height='150' ></a><br><center><a href='view.php?pid=$rsitem->picid'><b><h5>$rsitem->picname</h5></b></a><a href='art/$rsitem->img_name' rel='lytebox[vacation]' title='$rsitem->picname' ><b><h6>Click to enlarge</h6></b></a></center>";
echo "</td>";
}

echo "</tr>";
echo"</table>";
echo "<br><left><b>There are ".$count." paints in the Architecture Painting.</b></left>";

}
else
echo "<br><center><b><font size=4>There is no printes.</font></b></center>";
