...
<li><nobr><a href='../logoff.php' class='headerNavigation'>Log Off</a></nobr></li>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> » <a href="folk.php" class="headerNavigation">Folk Painting</a></td>
        <td align="right">
...
$db=mysql_select_db("art_gallery",$cn);
$count=0;
$sql="select * from gallery where cat='Folk'";
$rs=mysql_query($sql,$cn);
...
echo "</tr>";
echo"</table>";
echo "<br><left><b>There are ".$count." paints in the Folk Painting.</b></left>";
