...
<li><nobr><a href='../logoff.php' class='headerNavigation'>Log Off</a></nobr></li>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> &raquo; <a href="contact_us.php" class="headerNavigation">Contact Us</a></td>
        <td align="right">
...
<table class="infoBox" width="100%" border="0" cellpadding="1" cellspacing="0">
  ...
  <tr>
    <td class="boxText"><a href="pages.php?page=shipping">Shipping &amp; Returns</a><br><a href="pages.php?page=conditions">Conditions of Use</a><br><a href="pages.php?page=privacy_notice">Privacy Notice</a><br><a href="contact_us.html">Contact Us</a><br><a href="about_us">About Us</a></td>
...
<!-- body_text //-->
 ...
 <td class="central_column" width="100%" valign="top"><form name="contact_us" action="contactcheck.php" method="post"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
        <td><img src="image/pixel_trans.gif" alt="" width="100%" border="0" height="10"></td>
      </tr>
      <tr>
        <td><table class="infoBox" width="78%" border="0" cellpadding="2" cellspacing="1">
          <tbody><tr class="infoBoxContents">
            ...
            <td><table width="100%" border="0" cellpadding="2" cellspacing="0">
              ...
              <tr>
                <td class="main"><input name="name" type="text"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="main"><input name="email" type="text"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><textarea name="enquiry" wrap="soft" cols="62" rows="15"></textarea></td>
              </tr>
            </tbody></table></td>
          </tr>
        </tbody></table></td>
      ...
      <tr>
        <td><table class="infoBox" width="78%" border="0" cellpadding="2" cellspacing="1">
          <tbody><tr class="infoBoxContents">
            <td><table width="100%" border="0" cellpadding="2" cellspacing="0">
              <tbody><tr>
                <td width="10"><img src="image/pixel_trans.gif" alt="" width="10" border="0" height="1"></td>
                <td align="right"><input src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" type="image"></td>
