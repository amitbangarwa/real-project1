...
echo "<li><nobr><a href='selleraccount.php' class='headerNavigation'>My Account</a></nobr></li>";
else
...
?>	
	...
	<div class="toggleBox curtain filterValues" id="filter4PopularFilterValues">
		<div id="linkcontainer">
			<ul id="linklist">      
<li><a href="abstract.php">Abstract</a>&nbsp;<br><a href="folk.php">Folk</a>&nbsp;<br><a href="index.php?cPath=61">Modern</a>&nbsp;<br><a href="index.php?cPath=60">Traditional</a><br><a href="subjects.php?subject_id=4">Architecture</a></li><li><a href="subjects.php?subject_id=3">Animals</a></li><li><a href="subjects.php?subject_id=6">Floral</a></li><li><a href="subjects.php?subject_id=7">Nature</a></li><li><a href="subjects.php?subject_id=8">People</a></li><li><a href="subjects.php?subject_id=10">Other</a></li>			</ul>
		</div>
...
<font size='3'><i>Product(s) You Have Post</i></font><br><br>
<?php

$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
$db=mysql_select_db("art_gallery",$cn);
$unm=$_SESSION['usrnm'];
$sql="select * from gallery where emadd='$unm'";
$rs=mysql_query($sql,$cn);
echo'<table border="0" cellpadding="2" cellspacing="0" width="100%">';
echo'<tbody><tr>';
echo'<td class="main" align="left"><b><u>Artist Name</u></b></td><td class="main"><b><u>Paint name</u></b></td><td class="main"  align="center"><b><u>Product(s)</u></b></td><td class="main" align="right"><b><u>Price</u></b></td><td class="main" align="right"><b><u>Date of Postade</u></b></td></tr>';
...
echo'  <tr>           <td class="main"><a href="selleraccount.php"><img src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" width="100" height="22"></a></td></tr>';
echo'<tbody></table>';
?>
</td>
...
<div id="page_wrapper">
  ...
  <?php
if(isset($_SESSION['usrnm']))
echo"<a href='selleraccount.php' class='headerNavigation'>My Account</a> |";
else
