...
function check()
{
var gn=document.account_edit.gender.value;
var fn=document.account_edit.firstname.value;
var ln=document.account_edit.lastname.value;
var dob=document.account_edit.dob.value;
var ea=document.account_edit.email_address.value;
var tele=document.account_edit.telephone.value;
if(gn=="" || fn=="" || ln=="" || dob=="" || ea=="" || tele=="")
{
...
<li><nobr><a href="index.php">Home</a></nobr></li>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="http://www.icloudcenter.net/demos/icart/" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> &raquo; <a href="account_edit.php" class="headerNavigation">Account Edit</a></td>
        <td align="right">
...
<!-- body_text //-->
    ...
    <form name="account_edit" action="selleraccount.php" method="post"><input name="action" value="process" type="hidden"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
...
$sql="select * from sellerinfo where em_add='$usernm'";
$rs=mysql_query($sql,$cn);
...
echo"</tr>";
echo"<tr>";
echo"<td class='main'>Date of Birth:</td>";
echo"<td class='main'><input name='dob' value='$rsitem->dob' type='text'>&nbsp;<span class='inputRequirement'>*</span></td>";
echo"</tr>";
echo"<tr>";
echo"<td class='main'>E-Mail Address:</td>";
echo"<td class='main'><input name='email_address' value='$rsitem->em_add' type='text'>&nbsp;<span class='inputRequirement'>*</span></td>";
echo"</tr>";
echo"<tr>";
echo"<td class='main'>Telephone Number:</td>";
echo"<td class='main'><input name='telephone' value='$rsitem->ph_no' type='text'>&nbsp;<span class='inputRequirement'>*</span></td>";
echo"</tr>";
?>
                </tbody></table></td>
              </tr>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              <tbody><tr>
                ...
                <td align="right"><input src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" type="submit" name="countinue" onclick=check()></td>
