...
<li><nobr><a href="index.php">Home</a></nobr></li>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="selleraccount.php" class="headerNavigation">My Account</a></td>
        <td align="right">
...
<!-- information_eof //--></div>      <!-- left_navigation_eof //-->
      </div>
    </td>
<!-- body_text //-->
...
$sql="select *from sellerinfo where em_add='$usrname'and password='$pass1'";
$rs=mysql_query($sql,$cn);
...
if($rsitem==true)
{
	if($pass2 == $pass3)
	{
		$rs1=mysql_query("UPDATE sellerinfo SET password='$pass3' WHERE em_add='$usrname'");
		if($rs1)
echo"<table>";
...
$rs=mysql_query("UPDATE sellerinfo SET gender='$gender',firstname='$fn',lastname='$ln',dob='$dob',em_add='$em_add',ph_no='$teleph' WHERE em_add='$usernm'");
if($rs)
{
...
?>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              <tbody><tr>
                ...
                <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
                  <tbody><tr>
                    <td class="main"><img src="image/arrow_green.gif" alt="" border="0" width="8" height="8"> <a href="account_edit.php">View or change my account information.</a></td>
      ...
      <tr>
        ...
        <td><img src="image/pixel_trans.gif" alt="" border="0" width="100%" height="10"></td>
         ...
         <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
           <tbody><tr>
             <td class="main"><b>My Products</b></td>
             ...
             <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
               <tbody><tr>
                 ...
                 <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
                   ...
                   <tr>
                     <td class="main"><img src="image/arrow_green.gif" alt="" border="0" width="8" height="8"> <a href="add_product.html">Add new product.</a></td>

                   </tr>
                   
                   <tr>
                     <td class="main"><img src="image/arrow_green.gif" alt="" border="0" width="8" height="8"> <a href="products.php">View the products I have posted.</a></td>
                   </tr>
