...
<li><nobr><a href='../logoff.php' class='headerNavigation'>Log Off</a></nobr></li>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> &raquo; <a href="view_all_galleries.php" class="headerNavigation">View All Items</a></td>
        <td align="right">
...
<td class="central_column" width="100%" valign="top">
    ...
    <tbody><tr>
      <td>
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tbody><tr>
            <td colspan="2" class="pageHeading">All Galleries<br></td>

            <td class="pageHeading" align="right">
              <img src="image/table_background_products_new.gif" alt="HEADING_TITLE" title=" HEADING_TITLE " width="57" border="0" height="40">       <br>     </td>
</tr>          
<tr>
<?php
$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
...
echo '<table  align=center width="100%" border="0" cellpadding="3" cellspacing="0">';
echo"<tr><td class='main'><b>Artist Name</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td class='main'><b>Paint name</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td class='main'><b>Price</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td class='main'><b>Date Postade</b></td></tr>";
while($rsitem=mysql_fetch_object($rs))
{
$count=$count+1;
echo "<tr>";
echo "<td><a href='artistproduct.php?aid=$rsitem->artist_id'>$rsitem->artistname</a></td><td><a href='view.php?pid=$rsitem->picid'>$rsitem->picname</a></td><td><font size=2>$rsitem->price</font></td><td><font size=2>$rsitem->date</font></td>";
echo "</tr>";
}
echo "<table>";
echo "<br><left><b><font size=2>Total Paints are :-".$count."</font></b></left>";
...
?>
    ...
    <tr><td><img src="image/pixel_trans.gif" alt="" width="100%" border="0" height="10"></td></tr>
      
            
    <tr><td colspan="3"><img src="image/pixel_trans.gif" alt="" width="100%" border="0" height="10"></td></tr>
    </tbody></table>        
  </td>
