...
$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
$db=mysql_select_db("art_gallery",$cn);
$sql="select * from gallery where artistname='$search' or picname='$search' or cat='$search'";
$rs=mysql_query($sql,$cn);

echo'<table border="0" cellpadding="2" cellspacing="0" width="100%">';
echo'<tbody><tr>';
echo'<td class="main" align="left"><b><u>Artist Name</u></b></td><td class="main"><b><u>Paint name</u></b></td><td class="main"  align="center"><b><u>Product(s)</u></b></td><td class="main" align="right"><b><u>Price</u></b></td><td class="main" align="right"><b><u>Date of Posted</u></b></td><td class="main" align="right"><b><u>Status</u></b></td></tr>';
while($rsitem=mysql_fetch_object($rs))
{
echo"<tr><td class='main'><b>$rsitem->artistname</b></td><td class='main'><b>$rsitem->picname</b></td><td align='center'><img src='art/$rsitem->img_name' alt='$rsitem->picname' title=' $rsitem->picname ' border='0' width='120' height='90'></td><td class='main' align='right'><b>$ $rsitem->price</b></td><td class='main' align='right'><b>$rsitem->date</b></td><td class='main' align='right'><b>$rsitem->status</b></td></tr>";
}
echo'  <tr>           <td class="main"><a href="index.php"><img src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" width="100" height="22"></a></td></tr>';
echo'<tbody></table>';
if ($rsitem=="true")
{
}
