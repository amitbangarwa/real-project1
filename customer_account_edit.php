...
<!-- body_text //-->
    ...
    <form name="account_edit" action="accountcustomer.php" method="post"><input name="action" value="process" type="hidden"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
...
echo"<td class='main'><input name='email_address' value='$rsitem->email_address' type='text'>&nbsp;<span class='inputRequirement'>*</span></td>";
echo"</tr>";
echo"<tr>";
echo"<td class='main'>Telephone Number:</td>";
echo"<td class='main'><input name='telephone' value='$rsitem->telephone_no' type='text'>&nbsp;<span class='inputRequirement'>*</span></td>";
echo"</tr>";
?>
                </tbody></table></td>
              </tr>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              <tbody><tr>
                ...
                <td align="right"><input name="countinue" value="submit" type="hidden"><input src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" type="image"  onclick=check()></td>
