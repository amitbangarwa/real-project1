...
function message()
{
alert("YOU HAVE BEEN LOGOUT.THANK YOU..");
}
</script> 
...
<div id="page_wrapper">
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="http://www.icloudcenter.net/demos/icart/" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> &raquo; <a href="logoff.php" class="headerNavigation">Log Off</a></td>
        <td align="right">
...
session_destroy();
?>
<td class="central_column" width="100%" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
        <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr>
            ...
            <td valign="top"><table border="0" cellpadding="2" cellspacing="0" width="100%">
              ...
              <tbody><tr>
                <td class="pageHeading" align="center">You Are Successfully Log Off</td>
              </tr>
              <tr>
                <td><img src="image/pixel_trans.gif" alt="" border="0" width="100%" height="10"></td>
              </tr>
              <tr>
                <td class="main">You have been logged off your account. It is now safe to leave the computer.<br><br>Your shopping cart has been saved, the items inside it will be restored whenever you log back into your account.</td>
