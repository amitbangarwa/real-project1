...
<?php
if(isset($_SESSION['usrnm']))
echo'<font size="3" face="Times New Roman">Welcome back customer! Would you like to see the products which are available to purchase? <a href="view_all_galleries.php"><u>click here</u></a></font>';
else

echo'<font size="2"> <i>Welcome <span class="greetUser">Guest!</span> Would you like to <a href="login.php"><u>log yourself in</u></a>? Or would you prefer to <a href="create_account.html"><u>create an account</u></a>?</i></font>';
?>
    </td>      </tr>
