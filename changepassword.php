...
<td class="central_column" width="100%" valign="top">
    <form name="account_password" action="accountcustomer.php" method="post"><input name="action" value="process" type="hidden"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              ...
              <tbody><tr>
                ...
                <td align="right"><input name="submit" value="submit" type="hidden"><input src="image/change.jpg" alt="Change" title=" Change " border="0" type="image"  onclick=check()></td>
                <td width="10"><img src="image/pixel_trans.gif" alt="" border="0" width="10" height="1"></td>
              </tr>
            </tbody></table></td>
          </tr>
