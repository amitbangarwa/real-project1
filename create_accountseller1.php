...
$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
$db=mysql_select_db("art_gallery",$cn);
if($gender=="" || $fn=="" || $ln=="" || $dob=="" || $em_add=="" || $st_add=="" || $pincode==""  || $city=="" || $state=="" || $teleph=="" || $password=="")
header("location:create_accountseller.php");
else
{
if ($password1 == $password)
{
$sql="INSERT INTO sellerinfo(gender,firstname,lastname,dob,em_add,st_add,pincode,city,state,ph_no,password,date) VALUES ('$gender','$fn','$ln','$dob','$em_add','$st_add','$pincode','$city','$state','$teleph','$password','$today')";
$rs=mysql_query($sql,$cn);
if($rs=='true')
{
echo "<br><br><font size=6><center><u>YOU ARE SUCCESSFULLY REGISTERED</u></center></font>";
echo "<br><br><font size=5><u><center>Your Account information are in Details..</center></u></font><br>";
echo"<table border=1 align=center>";
echo"<tr><td><b>GENDER                       	 :</b></td><td><h3>$gender</h3></td></tr>";
echo"<tr><td><b>NAME                               	 :</b></td><td><h3>$fn $ln</h3></td></tr>";
echo"<tr><td><b>ADDRESS                          	 :</b></td><td><h3>$st_add $city $state $pincode</h3></td></tr>";
echo"<tr><td><b>DOB                                 	 :</b></td><td><h3>$dob</h3></td></tr>";
echo"<tr><td><b>CONTACT NO.                   :</b></td><td><h3>$teleph</h3></td></tr>";
echo"<tr><td><b>EMAIL                             	 :</b></td><td><h3>$em_add</h3></td></tr>";
echo "</table>";
...
{
echo"<br><center><font color='red'><b>Your password did not match !! Please <a href='create_accountseller.php'> <u>Try Again.</u></a></b></font></center>";
}
}
?>
</td>
