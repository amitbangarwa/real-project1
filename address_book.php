...
<form name="addressbook" action="accountcustomer.php" method="post" onsubmit="return check_form(addressbook);" enctype="multipart/form-data"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              <tbody><tr>
                ...
                <td align="right"><input name="Submit" value="submit" type="hidden"><input src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" type="image"  onclick=check()></td>
