...
?>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> » <a href="abstract.php" class="headerNavigation">Abstract Painting</a></td>
        <td align="right">
...
echo "</tr>";
echo"</table>";
echo "<br><left><b>There are ".$count." paints in the Abstract Painting.</b></left>";
