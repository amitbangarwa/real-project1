...
{
$sql="INSERT INTO customerinfo(gender,firstname,lastname,dob,email_address,street_address,post_code,city,state,telephone_no,password,date) VALUES ('$gender','$fn','$ln','$dob','$em_add','$st_add','$pincode','$city','$state','$teleph','$password','$today')";
$rs=mysql_query($sql,$cn);
if($rs=='true')
{
...
{
echo"<br><center><font color='red'><b>Your password did not match !! Please <a href='create_account.php'> <u>Try Again.</u></a></b></font></center>";
}
}
?>
</td>
