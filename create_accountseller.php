...
var cn=document.create_account.company.value;
var ci=document.create_account.company_image.value;
...
if(gn=="" || fn=="" || ln=="" || dob=="" || ea=="" || cn=="" || ci=="" || sa=="" || pc==""  || ct=="" || st=="" || tele=="" || pass=="" || passc==''")
{
...
<div id="page_wrapper">
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a>&raquo; <a href="create_account.html" class="headerNavigation">Create Account</a>&raquo; <a href="selleraccount.php" class="headerNavigation">Create Seller Account</a></td>
        <td align="right">
...
<td class="central_column" width="100%" valign="top">
      <form name="create_account" action="create_accountseller1.php" method="post" enctype="multipart/form-data"><input type="hidden" name="action" value="process">
