...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr>
            <td class="pageHeading">Order Submitted<br><br></td>
          </tr>
        </tbody>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
$pid=$rsitem1->pid;
$printnm=$rsitem1->printnm;
$rs2=mysql_query("INSERT INTO checkout (userid,pid,printnm,date) VALUES ('$usrnm','$pid','$printnm','$today')");
$rs3=mysql_query("UPDATE gallery SET status='sold' where picid='$pid'");
$rs4=mysql_query("DELETE FROM cart WHERE pid='$pid'");

}

echo'<tr><td class="main"><font size="3">Your order has been Submited.<br><br></font></td></tr>';
echo'<tr><td><a href="index.php"><img src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" type="image"></a></td></tr>';
}
