...
?>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> &raquo; <a href="shopping_cart.php" class="headerNavigation">Shopping Cart</a></td>
        <td align="right">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr>
            <td class="pageHeading">What's In My Cart?<br><br></td>
...
echo"<tr>
<td align='left'><font size='2'><b>Remove</b></font></td>
<td align='center'><font size='2'><b>Artist Name</b></font></td>
<td align='center'><font size='2'><b>Product(s)</b></font></td>
<td align='right'><font size='2'><b>Price</b></font></td>
</tr>
<form action='shopping_cart.php' method ='post'>";

while($rsitem1=mysql_fetch_object($rs))
{
if ($rsitem1->status=="Incart")
{

echo "<tr>";


echo "<td class='productListing-data' align='left' valign='top'><input name='Cart_delete' value='$rsitem1->pid' type='checkbox'></td>
<td align='center' valign='top' class='main'><font size='2'>$rsitem1->artistnm</td>

<td align='center'><img src='art/$rsitem1->img_nm' alt='$rsitem1->printnm' title=' $rsitem1->printnm ' border='0' width='120' height='90'>   <font size='2'><br>$rsitem1->printnm</font></td>
<td valign='top' align='right'><font size=2>$ $rsitem1->price</font></td>";
$total =$total + $rsitem1->price;
 echo"</tr>";
...
echo"<tr><td valign='top' align='right'><font size='2'><b>Total: </b>$ $total</font></td></tr>";
echo "</table>";

echo'<table class="infoBox" border="0" cellpadding="2" cellspacing="1" width="100%">';
echo'          <tbody><tr class="infoBoxContents">';
          echo'  <td><table border="0" cellpadding="2" cellspacing="0" width="100%">';
             echo' <tbody><tr>';
        echo'        <td width="10"><img src="image/pixel_trans.gif" alt="" border="0" width="10" height="1"></td>';
    echo'            <td class="main"><input name="action" value="submit" type="hidden"><input src="image/button_update_cart.gif" alt="Update Cart" title=" Update Cart " border="0" type="image" width="100" height="22"></td>';
   echo'             <td class="main"><a href="view_all_galleries.php"><img src="image/button_continue_shopping.gif" alt="Continue Shopping" title=" Continue Shopping " border="0" width="130" height="22"></a></td>';

if(isset($_SESSION['usrnm']))                
{
echo'<td class="main" align="right"><a href="checkout_shipping.php"><img src="image/button_checkout.gif" alt="Checkout" title=" Checkout " border="0" width="100" height="22"></a></td>';
}
else
{
echo'<td class="main" align="right"><a href="login.php"><img src="image/button_checkout.gif" alt="Checkout" title=" Checkout " border="0" width="100" height="22"></a></td>';        
}
echo'        <td width="10"><img src="image/pixel_trans.gif" alt="" border="0" width="10" height="1"></td>';
echo'              </tr>';
 echo'           </tbody></table></td>';
...
{
$remove=$_POST['Cart_delete'];
$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
$db=mysql_select_db("art_gallery",$cn);
$sql="DELETE FROM cart WHERE pid='$remove'";
$rs=mysql_query($sql,$cn);
$rs1=mysql_query("UPDATE gallery SET status='' WHERE pid='$remove'");
if ($rs)
