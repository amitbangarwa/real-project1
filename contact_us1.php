  ...
  <div id="menu_bar">
    <div id="navcontainer">
      ...
      <ul id="navlist" style="">
        ...
        <li><nobr><a href="contact_us.html" class="headerNavigation">Contact Us</a></nobr></li>
           <?php
session_start();
...
<!-- body_text //-->
 <td class="central_column" width="100%" valign="top"><form name="contact_us" action="" method="post"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
      ...
      <tr>
        <td class="main" align="center"><img src="image/table_background_man_on_board.gif" alt="Contact Us" title=" Contact Us " align="left" border="0">Your enquiry has been successfully sent to the Store Owner.</td>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              <tbody><tr>
                ...
                <td align="right"><a href="index.php"><img src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" width="100" height="22"></a></td>
                <td width="10"><img src="image/pixel_trans.gif" alt="" border="0" width="10" height="1"></td>
              </tr>
            </tbody></table></td>
          </tr>
...
<div id="page_wrapper">
  <div id="page_footer">
    <p>
      ...
      <a href="contact_us.html" class="headerNavigation">Contact Us</a> |
  <?php
if(isset($_SESSION['usrnm']))
