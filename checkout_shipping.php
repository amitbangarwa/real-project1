...
?>
 ...
 <div id="page_header">
  ...
  <div id="page_breadcrumb">
    ...
    <tr valign="middle">        
<td align="left"><a href="index.php" class="headerNavigation">Top</a> &raquo; <a href="index.php" class="headerNavigation">Catalog</a> &raquo; <a href="checkout_shipping.php" class="headerNavigation">Checkout</a></td>
        <td align="right">
...
<td class="central_column" width="100%" valign="top"><form name="checkout_address" action="checkout_confirmation.php" method="post"><input name="action" value="process" type="hidden"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
...
header("location:checkout_shipping_address.php");
else
{
$cn=mysql_connect("localhost","root","") or die("Error in connecting database");
$db=mysql_select_db("art_gallery",$cn);
...
?>
          ...
          <tbody><tr class="infoBoxContents">
            <td><table border="0" cellpadding="2" cellspacing="0" width="100%">
              <tbody><tr>
                ...
                <td class="main" width="50%" valign="top">Please choose from your address book where you would like the items to be delivered to.<br><br><a href="checkout_shipping_address.php"><img src="image/button_change_address.gif" alt="Change Address" title=" Change Address " border="0" width="130" height="22"></a></td>
      ...
      <tr>
        <td><table class="infoBox" border="0" cellpadding="2" cellspacing="1" width="100%">
          ...
          <td class="main" align="right"><input name="action" value="submit" type="hidden"><input src="image/button_continue.gif" alt="Continue" title=" Continue " border="0" type="image"></a></td>
